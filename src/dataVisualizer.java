...
public class dataVisualizer extends JFrame {
    ...
    public dataVisualizer(String filename) {
        ...
        lines.removeFirst(); // remove header data
        ...
        // print out file headers so user can review
        System.out.println("File Headers:");
        System.out.println(headers);
        // check if running default options or input for custom
        ...
        // create frame for data visualization
